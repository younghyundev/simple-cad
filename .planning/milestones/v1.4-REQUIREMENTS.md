...
- Referenced IMAGE/XREF/UNDERLAY files are not rendered, uploaded as a bundle, or emitted during browser DXF export yet.
- Full CAD dimension style editing and annotative scale support remain deferred.
- Browser-only DWG parsing remains out of scope; DWG still requires a server conversion API.
