...
**Success criteria:**
1. SPLINE/ELLIPSE는 가능한 경우 editable entity로 보존된다.
2. HATCH, LEADER/MLEADER, ATTRIB/ATTDEF 처리 결과가 보존/근사/미지원으로 명확히 분류된다.
3. BLOCK/INSERT 속성과 중첩 변환 정보가 기존보다 더 많이 보존된다.
4. 단위, 도면 범위, model/paper space 메타데이터가 import/export 요약에 포함된다.
